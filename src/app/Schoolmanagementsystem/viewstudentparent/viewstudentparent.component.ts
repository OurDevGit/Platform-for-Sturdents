...
@Component({
  selector: "app-viewstudentparent",
  templateUrl: "./viewstudentparent.component.html",
  styleUrls: ["./viewstudentparent.component.scss"]
})
export class ViewstudentparentComponent implements OnInit {
