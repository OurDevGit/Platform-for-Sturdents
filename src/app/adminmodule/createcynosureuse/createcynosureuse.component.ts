...
@Component({
  selector: "app-createcynosureuse",
  templateUrl: "./createcynosureuse.component.html",
  styleUrls: ["./createcynosureuse.component.scss"]
})
export class CreatecynosureuseComponent implements OnInit {
  deletecheck: boolean;
  showdisplay: boolean;
  accesslist: any;
  ...
  addusertocynousre() {
    ...
    this.schools.addUserCynosure<Schooluserss>(this.Schooluserss).subscribe(
      (data: Schooluserss) => {
      ...
      () => {
        ...
        this.router.navigate(["main/assignusertocynosure"]);
      }
    );
  }
  resetselecterror(i) {
  ...
  check_data(canproceed: number) {
    ...
    if (this.model.roleID === -1) {
      this.er_role = "Select Roles";
      has_error = true;
    } else this.er_role = "";
    if (this.t_mobile_countrycode === "Select Country Code2") {
      this.er_countrycode1 = "Invalid Mobile Country Code";
      has_error = true;
    } else this.er_countrycode1 = "";
    if (this.t_phone_countrycode === "Select Country Code1") {
      this.er_countrycode2 = "Invalid Phone Country Code";
      has_error = true;
    } else {
      this.er_countrycode2 = "";
    }
